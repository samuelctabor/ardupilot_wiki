...
If Soaring is enabled when beyond this :ref:`SOAR_MAX_RADIUS<SOAR_MAX_RADIUS>`, it will not enter THERMAL mode, i.e. the same effect as if the middle RC switch option for Soaring was used. 

.. warning:: If altitude is below :ref:`SOAR_ALT_MIN<SOAR_ALT_MIN>`, when Soaring is enabled beyond this limit, it will begin gliding, but not climb or RTL, nor enter THERMAL mode, and will glide to the ground! 
